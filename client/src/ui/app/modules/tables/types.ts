...
export type TablesDispatch =
  ...
  | { type: 'admin/tables/setColumns', name: keyof TablesState, payload: string[] }
  | { type: 'admin/tables/setSearch', name: keyof TablesState, payload: string }
  | { type: 'admin/tables/setSort', name: keyof TablesState, payload: { sortBy: string, sortDirection: SortDirectionType }}
  | { type: 'admin/tables/resetFilters', name: keyof TablesState }
  | { type: 'admin/tables/columnWidth', name: keyof TablesState, dataKey: string | number, payload: number }
...
export type OnRowClick<T> = (props: { rowData: T, index: number, event: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement> }) => void;
...
export type ISetSort = (params: { sortBy: string, sortDirection: SortDirectionType }) => void;
export type ISetSearch = (payload: string) => void;
export type ISetFilter = (fieldName: string | number, params: TableFilterOptions) => void;
